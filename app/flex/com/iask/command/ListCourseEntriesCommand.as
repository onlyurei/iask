package com.iask.command
{
	...
	public class ListCourseEntriesCommand implements ICommand, IResponder
	{
		public function ListCourseEntriesCommand()
		{
		}
		...
		public function result(data:Object):void
		{
			...
			{
				Alert.show("您可能在这台计算机上用其他帐号登录了本系统。", "获取课程问题库失败");
				return;
			}
			var model:IaskModelLocator = IaskModelLocator.getInstance();
			model.setCourseEntries(_course, XMLList(data.result.children()), true);
		}
