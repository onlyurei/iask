package com.iask.command
{
	...
	public class ListCourseTeachersCommand implements ICommand, IResponder
	{
		public function ListCourseTeachersCommand()
		{
		}
		...
		public function result(data:Object):void
		{
			...
			{
				Alert.show("您可能在这台计算机上用其他帐号登录了本系统。", "获取选定课程的教师列表失败");
				return;
			}
			var model:IaskModelLocator = IaskModelLocator.getInstance();
			model.setCourseTeachers(_course, XMLList(data.result.children()));
		}
