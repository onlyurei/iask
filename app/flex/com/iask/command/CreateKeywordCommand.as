package com.iask.command
{
	...
	public class CreateKeywordCommand implements ICommand, IResponder
	{
		public function CreateKeywordCommand()
		{
		}
		...
		public function execute(event:CairngormEvent):void
		{
			...
			delegate.createKeyword(Keyword(event.data));
		}
		...
		public function result(data:Object):void
		{
			...
			{
				Alert.show("您可能在这台计算机上用其他帐号登录了本系统。", "为条目添加关键词失败");
			}
			else
			{
